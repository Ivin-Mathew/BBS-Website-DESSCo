...
function VViewPartner({ partner }: VViewPartnerProps) {
  if (!partner) {
    return null;
  }
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-br from-blue-900 to-blue-950 py-32">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1542744094-24638eff58bb?w=1200')] bg-cover bg-center opacity-10"></div>
        </div>
      ...
      <div id="solutions" className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-16">Display Solutions</h2>
      ...
      <div className="py-24">
        <div className="max-w-7xl mx-auto px-4">
          <div className="bg-gradient-to-br from-blue-900 to-blue-950 rounded-3xl p-12 text-center">
            <h2 className="text-3xl font-bold text-white mb-6">Ready to Transform Your Visual Experience?</h2>
            <p className="text-xl text-blue-100 mb-8">
              Contact us to learn more about VView's innovative display solutions
            </p>
